...
sql.getSelect = () => {
  const statement = db()
    .select(
      ...
      `${TABLE}.traded_projected_percent_hr`,
      `${TABLE}.traded_block_number`,
      `${TABLE}.traded_tx`,
      `${TABLE}.traded_source_tokens`,
      `${TABLE}.traded_source_token_symbol`,
      `${TABLE}.traded_dst_tokens`,
      `${TABLE}.traded_dst_token_symbol`,
      `${TABLE}.traded_gas_spent`,
      `${TABLE}.closed_trade`,
      `${TABLE}.closed_at`,
      `${TABLE}.closed_tx`,
      `${TABLE}.closed_price_diff`,
      `${TABLE}.closed_profit_loss`,
      `${TABLE}.closed_profit_loss_percent`,
      `${TABLE}.closed_profit_loss_percent_hr`,
      `${TABLE}.closed_feed_price`,
      `${TABLE}.closed_oracle_price`,
      `${TABLE}.closed_block_number`,
      `${TABLE}.testing`,
      `${TABLE}.closed_cut_losses`,
      `${TABLE}.closed_source_tokens`,
      `${TABLE}.closed_source_token_symbol`,
      `${TABLE}.closed_dst_tokens`,
      `${TABLE}.closed_dst_token_symbol`,
      `${TABLE}.closed_gas_spent`,
      `${TABLE}.created_at`,
      `${TABLE}.updated_at`,
    )
    .from(TABLE);
